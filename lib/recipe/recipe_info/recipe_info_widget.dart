...
class _RecipeInfoWidgetState extends State<RecipeInfoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecipeInfoModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'RecipeInfo'});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<RecipeRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final recipeInfoRecipeRecord = snapshot.data!;
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 20.0, 0.0, 0.0),
                                      child: Text(
                                        'Make sure you hit \"save\" to store this recipe!',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Inter',
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'RECIPE_INFO_PAGE_SAVE_BTN_ON_TAP');
                                      ...
                                      text: recipeInfoRecipeRecord.saved
                                          ? 'Saved'
                                          : 'Save',
                                      icon: const Icon(
                                        Icons.save,
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'RECIPE_INFO_PAGE_DELETE_BTN_ON_TAP');
                                        logFirebaseEvent('Button_backend_call');
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'RECIPE_INFO_PAGE_BACK_BTN_ON_TAP');
